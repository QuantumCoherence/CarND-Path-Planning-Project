...
Vehicle::Vehicle(float s, float d, float x, float y, float vx, float vy, string state){
...
Vehicle::Vehicle(int egoid,float s, float d, float x, float y, float v, float yaw,string state){
...
vector<Vehicle> Vehicle::generate_predictions(int horizon) {
    ...
    */
    ...
    for(int i = 0; i < horizon; i++) {
      ...
      predictions.push_back(Vehicle(this->lane, next_s, next_v, 0.0));
  	}
    return predictions;
